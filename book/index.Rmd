...
link-citations: yes
description: |
  This book is designed for students who have no prior training in data skills and/or statistical analysis.
...
knitr::write_bib(c(
  .packages(), 'bookdown', 'tidyverse', 'tinytex', 'webexercises'
), 'packages.bib')
...
**Summary:** Materials for Quantitative Fundamentals
